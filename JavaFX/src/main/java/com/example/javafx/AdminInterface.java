...
class AdminInterface implements UserInterface {
    ...
    public void displayUI(Stage primaryStage, String utilizator) {
        ...
        String sqlQuery = "SELECT U.ID_Utilizator, A.ID_Administrator,U.Nume, U.Prenume, U.cnp, U.adresa, U.telefon, U.email, U.cont_IBAN, U.Numar_Contract " +
                "FROM Utilizatori U " +
        ...
        try (PreparedStatement preparedStatement = conexiune.prepareStatement(sqlQuery)) {
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                if (resultSet != null && resultSet.next()) {
                    int idSuperAdmin  = resultSet.getInt("ID_Administrator");
                    setIdAdmin(idSuperAdmin);

                    afisareInterfataAdmin(primaryStage, resultSet);
                }
            }
    ...
    private void afisareInterfataAdmin(Stage primaryStage, ResultSet resultSet) {
        try {
            ...
            butoaneLayout.add(adaugareProfesorButton,1,1);
            butoaneLayout.add(stergereUtilizatorButton, 1, 2);

            butoaneLayout.add(asociereCursProfesorButton, 2, 0);
            ...
            primaryStage.setTitle("Dashboard Administrator");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void handleAfisareUtilizatori() {
        ...
        String sqlQuery = "SELECT * FROM Utilizatori WHERE Tip_Utilizator <> 'SuperAdministrator' AND Tip_Utilizator <> 'Administrator' ";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void handleStergereUtilizator() {
        ...
        populeazaComboBoxStudentiProfesori(comboBoxUtilizatori);
    ...
    private void populeazaComboBoxStudentiProfesori(ComboBox<String> comboBox) {
        conexiune = DatabaseConnection.getConnection();
        ...
        String sql = "SELECT ID_Utilizator, Nume, Prenume, Tip_Utilizator FROM Utilizatori " +
                "WHERE Tip_Utilizator = 'Student' OR Tip_Utilizator = 'Profesor'";
        try (PreparedStatement preparedStatement = conexiune.prepareStatement(sql)) {
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void handleAfisareDetaliiCurs(String numeDisciplina, Stage cautareCursStage) {
        ...
        executaInterogareSiPopuleazaTabel(detaliiCursLayout, sqlQueryStudenti, numeDisciplina, "Studenți");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void handleFiltrareUtilizatori() {
        ...
        String[] tipuriUtilizatori = {"Student", "Profesor"};
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void adaugaDatePersonaleAdminInVBox(VBox vbox) {
        ...
        String sql = "SELECT Tip_Utilizator, Nume, Prenume, Adresa, Email, Telefon, Cont_IBAN, Numar_Contract " +
                ...
                "JOIN Utilizatori U ON U.ID_Utilizator = A.ID_Utilizator " +
                "WHERE A.ID_Administrator = ?";

        try (PreparedStatement preparedStatement = conexiune.prepareStatement(sql)) {
            preparedStatement.setInt(1, getIdAdmin());
            ResultSet resultSet = preparedStatement.executeQuery();
